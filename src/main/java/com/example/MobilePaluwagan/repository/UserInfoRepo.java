...
public interface UserInfoRepo extends JpaRepository<UserInfo, Long> {
    ...
    @Query(value = "SELECT ul.id AS user_id, ul.is_online AS isOnline,up.first_name, up.last_name, up.profile_image , r.role_name, up.verified_date, ul.has_savings_account, ul.has_loan " +
            "FROM user_login ul " +
